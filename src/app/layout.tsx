...
export const metadata: Metadata = {
  ...
  description:
    "Plataforma SaaS para agencias despachantes e importadores. Calculadora NANDINA, consulta DIM, rastreador de envíos, generador de planillas y más.",
  keywords:
    "aduana Bolivia, NANDINA, calculadora tributos, despacho aduanero, importacion Bolivia",
  openGraph: {
